...
if index1 != -1:
    ...
    # index1 = 3, len substring is 2 so this is 5
    # (substring, 5) is essentially saying that it starts looking at the 5th index of the string and takes the next instance
